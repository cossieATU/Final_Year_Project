...
CT_MODEL_PATH = "/home/atu/env/folder/nllb-200-3.3B-ct2-fp16"  # Change to your model path
SP_MODEL_PATH = "/home/atu/env/folder/flores200_sacrebleu_tokenizer_spm.model"  # Change to your SentencePiece model path
        ...
        try:
            ...
            if not data_queue.empty():
                ...
                for chunk in text_chunks:
                    ...
                    # Second instance of Amazon Polly for other language.
